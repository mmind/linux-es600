...
/* FIXME: only on 5624? is referenced in all datasheets. */
#define ALC5623_PWR_DOWN_CTRL			0x26
...
#define ALC5623_DAI_I2S_PCM_MODE_5624		(1 <<  6)
#define ALC5623_DAI_MAIN_I2S_BCLK_POL_CTRL	(1 <<  7)
#define ALC5623_DAI_MAIN_I2S_BCLK_POL_CTRL_5624	(1 << 12)
...
#define ALC5623_PWR_ADD1_SHORT_CURR_DET_EN_5624	(1 <<  5)
...
#define ALC5623_PWR_ADD1_MAIN_BIAS_5624		(1 <<  1)
#define ALC5623_PWR_ADD1_AUX_OUT_ENH_AMP	(1 <<  0) /* rsvd on 5622 */
#define ALC5623_PWR_ADD1_DAC_REF_5624		(1 <<  0)
...
#define ALC5623_MISC_DISABLE_FAST_VREF		(1 << 15)
...
#define ALC5623_MISC_M_DAC_L_INPUT_5624		(1 <<  6)
#define ALC5623_MISC_M_DAC_R_INPUT_5624		(1 <<  5)
#define ALC5623_MISC_IRQOUT_INV_CTRL		(1 <<  0)

#define	ALC5623_PSEDUEO_SPATIAL_CTRL		0x60
#define ALC5623_EQ_CTRL				0x62
#define	ALC5624_STEREO_DAC_CLK_CTRL1		0X60
#define ALC5624_STEREO_DAC_CLK_CTRL2		0X62
