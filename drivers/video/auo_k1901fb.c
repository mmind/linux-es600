...
//from Kindle => check
#define AUOK1901_CMD_PIP_DMA_START	0x1008
#define AUOK1901_CMD_PIP_DMA_STOP	AUOK190X_CMD_DATA_STOP

#define AUOK1901_CMD_DDMA_START		0x1009

//from Kindle => check
#define AUOK1901_CMD_DISP_CURSOR_START	0x100A
#define AUOK1901_CMD_DISP_PIP_START	0x100B
#define AUOK1901_CMD_READ_DATA		0x4002
...
static int __devinit auok1901fb_probe(struct platform_device *pdev)
{
	...
	init.set_content_type = auok1901_set_content_type;
