...
static int s3c2443_i2s_cfg_gpio(struct platform_device *pdev)
{
...
static struct resource s3c2443_iis_resource[] = {
	[0] = {
...
struct platform_device s3c2443_device_iis = {
	.name		  = "samsung-i2s",
	.id		  = -1,
	.num_resources	  = ARRAY_SIZE(s3c2443_iis_resource),
	.resource	  = s3c2443_iis_resource,
	.dev = {
