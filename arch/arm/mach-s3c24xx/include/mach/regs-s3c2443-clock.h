...
#define S3C2443_WKUPSTAT		S3C2443_CLKREG(0x6C)
...
#define S3C2443_PLLCON_STOPON		(1 << 25)
...
#define S3C2443_PWRMODE_SLEEP		0x2BED

#define S3C2416_PWRCFG_STANDBYWFI	(1 << 17)
#define S3C2416_PWRCFG_DEEPSTOP		(1 << 16)
#define S3C2443_PWRCFG_SLEEP		(1 << 15)
#define S3C2443_PWRCFG_RTCOFF		(1 << 8)
#define S3C2443_PWRCFG_RTCTICKOFF	(1 << 7)
#define S3C2443_PWRCFG_USBPHY		(1 << 4)
#define S3C2443_PWRCFG_OSC_SLEEP	(1 << 3)
#define S3C2443_PWRCFG_OSC_STOP		(1 << 2)
#define S3C2443_PWRCFG_BATF_MASK	(3 << 0)
#define S3C2443_PWRCFG_BATF_ENABLE	(1 << 0)

#define S3C2443_URSTCON_FUNCRST		(1 << 2)
#define S3C2443_URSTCON_HOSTRST		(1 << 1)
...
#define S3C2443_UCLKCON_HOST_CLKEN	(1 << 1)
